  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-6 py-6">
        ...
        <motion.section
          className="mb-16 grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-end"
          initial="hidden"
          animate="show"
        ...
        >
          <div>
            ...
            >
              The full workspace will live here.
            </motion.h2>
            ...
            >
              The current prototype is active on the home page.
            </motion.p>
            ...
            >
              <Link
                href="/"
                className="inline-flex items-center gap-2 rounded-xl bg-red-500 px-5 py-3 text-sm font-medium text-white shadow-[0_12px_28px_rgba(239,68,68,0.22)] transition hover:bg-red-600"
              >
                Open prototype
                <ArrowRight size={16} />
              </Link>
